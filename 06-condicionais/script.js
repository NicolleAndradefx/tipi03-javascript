...
if(nomealuno === "Maria"){
    console.log("Ola Maria"); //perceba que esse bloco foi ignorado
}

//else (condição se falsa ou se aprimeira nao for atendida)
const logado = false;
...
switch(idade){
    case 18:
        console.log("O ususário é maior de idade");
        break;
    case 17:
